...
Product and planning package for the team in **[docs/](docs/README.md)** — thesis,
users and journeys, feature concepts, MVP-vs-stretch scope, acceptance criteria,
permissions/privacy/safety, sponsor integration hypotheses, demo narrative,
milestones, and registers of open questions and unverified assumptions.

Fast paths: [product thesis](docs/product-thesis.md) ·
[scope](docs/scope.md) · [decision matrix](docs/decision-matrix.md) ·
